...
void get_items(char s, int rows, int columns, int m[][columns]); 
void print_matrix( int rows, int columns, int matrix[][columns], char s); 
void matrix_multi(int rows_1, int columns_1, int columns_2, int columns, int matrix_1[][columns_1], int matrix_2[][columns_2], int result[][columns]);
...
// part B
    ...
    get_items('A', ar, ac, A_matrix);
    get_items('B', br, bc, B_matrix);

    matrix_multi(ar, ac, bc, bc, A_matrix, B_matrix, C_matrix);

    print_matrix(ar, ac, A_matrix, 'A'); 
    print_matrix(br, bc, B_matrix, 'B'); 
    print_matrix(ar, bc, C_matrix, 'C'); 
